...
public class Enemy : Interactable
{
    ...
    override public void Interact()
    {
        base.Interact();
        /*
        partyManager.partyMembers.ForEach(member =>
        {
            CharacterCombat combat = member.GetComponent<CharacterCombat>();
         
            if (combat != null && myStats != null)
            {
                combat.Attack(myStats);
            }
        });
        Debug.Log("Enemy " + transform.name + " has been interacted with!");
        // Add enemy-specific interaction logic here
